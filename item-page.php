...
<div id="page">
	<div class="container" id="leftAdContainer"> This is where an ad would go</div>

	<div class="container" id="itemDetailContainer">
			...
			<h1><?php echo $item_name ?> </h1>
				<div class="row">
					<div id="firstCol" class="col-lg-10 col-md-10 col-sm-10" style="">
						...
						<div class="container" id="midContainer">
							<div id="item-id" class="">
								<h3> Item ID#: </h3>
								<p id="item-id-border" style="border-left: 6px solid red;"><?php echo $item_id ?></p>
							</div>
							<br>
						</div>
					...
					<div id="thirdCol" class="col-lg-2 col-md-2 col-sm-2" style="">
						...
						<div id=<?php echo $item_id?>class="item-add-to-cart"> <!--style="padding-top: 120px; right: 0;"-->
